...
from dashboard.tabs.weekly_weather import layout as weekly_weather_layout
...
weekly_weather_div = weekly_weather_layout(app)
daily_weather_div = daily_weather_layout(app)
